...
class pass1 {
    ...
    public static void main(String args[]) throws Exception{
        int locate=0;
        int litcount = 0;
        BufferedReader reader = new BufferedReader(new FileReader("input.txt")); //FOR INPUT FILE
        BufferedWriter writer= new BufferedWriter(new FileWriter("output.txt")); //FOR OUTPUT FILE
